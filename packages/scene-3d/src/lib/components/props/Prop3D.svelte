...
{#if visible}
  ...
  {:else if propType === PropType.BIGCLUB}
    <Club3D {propState} {color} {visible} {isActivePlayer} {length} scale={BIG_SCALE} />

  {:else if propType === PropType.FAN}
    <Fan3D {propState} {color} {visible} {isActivePlayer} {length} />
  ...
  {:else if propType === PropType.BIGHOOP}
    <Hoop3D {propState} {color} {visible} {isActivePlayer} {length} scale={BIG_SCALE} />
  ...
  {:else if propType === PropType.CHICKEN}
    <Chicken3D {propState} {color} {visible} {isActivePlayer} {length} />
  {:else if propType === PropType.BIGCHICKEN}
    <Chicken3D {propState} {color} {visible} {isActivePlayer} {length} scale={BIG_SCALE} />

  {:else if propType === PropType.GUITAR}
    <Guitar3D {propState} {color} {visible} {isActivePlayer} {length} />
  {:else if propType === PropType.UKULELE}
    <Guitar3D {propState} {color} {visible} {isActivePlayer} {length} scale={0.75} />

  {:else if propType === PropType.DOUBLESTAR}
    <Doublestar3D {propState} {color} {visible} {isActivePlayer} {length} />
  {:else if propType === PropType.BIGDOUBLESTAR}
    <Doublestar3D {propState} {color} {visible} {isActivePlayer} {length} scale={BIG_SCALE} />

  {:else if propType === PropType.EIGHTRINGS}
    <Eightrings3D {propState} {color} {visible} {isActivePlayer} {length} />
  {:else if propType === PropType.BIGEIGHTRINGS}
    <Eightrings3D {propState} {color} {visible} {isActivePlayer} {length} scale={BIG_SCALE} />

  {:else if propType === PropType.CONTACTBALL}
    <Ball3D {propState} {color} {visible} {isActivePlayer} {length} />
  {:else if propType === PropType.BIGCONTACTBALL}
    <Ball3D {propState} {color} {visible} {isActivePlayer} {length} scale={BIG_SCALE} />
  ...
  {:else if propType === PropType.TORCH}
    <Torch3D {propState} {color} {visible} {isActivePlayer} {length} />
  {:else if propType === PropType.BIGTORCH}
    <Torch3D {propState} {color} {visible} {isActivePlayer} {length} scale={BIG_SCALE} />

  {:else if propType === PropType.POI}
    <Poi3D {propState} {color} {visible} {isActivePlayer} {length} />

  {:else if propType === PropType.HAND}
    <!-- Hand = no prop visible, just the trail indicator -->
    <Staff3D {propState} {color} visible={false} {isActivePlayer} {length} />
