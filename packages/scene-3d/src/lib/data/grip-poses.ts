...
import { GripType, type GripPose } from '../domain/GripPose.js';
...
const IDLE_POSE: GripPose = {
  ...
  rotations: [
    ...
    [0.0872, 0.0, 0.0, 0.9962],     // Index1: 10deg curl
    [0.1305, 0.0, 0.0, 0.9914],     // Index2: 15deg curl
    [0.0872, 0.0, 0.0, 0.9962],     // Index3: 10deg curl
    [0.1045, 0.0, 0.0, 0.9945],     // Middle1: 12deg
    [0.1564, 0.0, 0.0, 0.9877],     // Middle2: 18deg
    [0.1045, 0.0, 0.0, 0.9945],     // Middle3: 12deg
    [0.1305, 0.0, 0.0, 0.9914],     // Ring1: 15deg
    [0.1736, 0.0, 0.0, 0.9848],     // Ring2: 20deg
    [0.1305, 0.0, 0.0, 0.9914],     // Ring3: 15deg
    [0.1564, 0.0, 0.0, 0.9877],     // Pinky1: 18deg
    [0.1908, 0.0, 0.0, 0.9816],     // Pinky2: 22deg
    [0.1564, 0.0, 0.0, 0.9877],     // Pinky3: 18deg
  ],
};
...
const SQUARE_POSE: GripPose = {
  ...
  rotations: [
    ...
    [0.342, 0.0, 0.0, 0.9397],         // Thumb2: 40deg curl around shaft
    [0.2588, 0.0, 0.0, 0.9659],        // Thumb3: 30deg tip contact
    [0.6088, 0.0, 0.0, 0.7934],        // Index1: 75deg curl
    [0.6756, 0.0, 0.0, 0.7373],        // Index2: 85deg curl
    [0.5, 0.0, 0.0, 0.866],            // Index3: 60deg curl
    [0.6293, 0.0, 0.0, 0.7771],        // Middle1: 78deg
    [0.6947, 0.0, 0.0, 0.7193],        // Middle2: 88deg
    [0.515, 0.0, 0.0, 0.8572],         // Middle3: 62deg
    [0.6428, 0.0, 0.0, 0.766],         // Ring1: 80deg
    [0.7071, 0.0, 0.0, 0.7071],        // Ring2: 90deg
    [0.5373, 0.0, 0.0, 0.8434],        // Ring3: 65deg
    [0.6561, 0.0, 0.0, 0.7547],        // Pinky1: 82deg
    [0.7071, 0.0, 0.0, 0.7071],        // Pinky2: 90deg
    [0.5592, 0.0, 0.0, 0.829],         // Pinky3: 68deg
  ],
};
...
const PENCIL_POSE: GripPose = {
  ...
  rotations: [
    ...
    [0.2588, 0.0, 0.0, 0.9659],        // Thumb2: 30deg flex
    [0.1736, 0.0, 0.0, 0.9848],        // Thumb3: 20deg tip
    [0.342, 0.0, 0.0, 0.9397],         // Index1: 40deg - primary pinch
    [0.4226, 0.0, 0.0, 0.9063],        // Index2: 50deg
    [0.2588, 0.0, 0.0, 0.9659],        // Index3: 30deg
    [0.3007, 0.0, 0.0, 0.9537],        // Middle1: 35deg - support
    [0.3827, 0.0, 0.0, 0.9239],        // Middle2: 45deg
    [0.2164, 0.0, 0.0, 0.9763],        // Middle3: 25deg
    [0.1305, 0.0, 0.0, 0.9914],        // Ring1: 15deg - relaxed
    [0.1736, 0.0, 0.0, 0.9848],        // Ring2: 20deg
    [0.0872, 0.0, 0.0, 0.9962],        // Ring3: 10deg
    [0.1564, 0.0, 0.0, 0.9877],        // Pinky1: 18deg - relaxed
    [0.1908, 0.0, 0.0, 0.9816],        // Pinky2: 22deg
    [0.1045, 0.0, 0.0, 0.9945],        // Pinky3: 12deg
  ],
};
...
const CRADLE_POSE: GripPose = {
  ...
  rotations: [
    ...
    [0.1736, 0.0, 0.0, 0.9848],        // Thumb2: 20deg
    [0.0872, 0.0, 0.0, 0.9962],        // Thumb3: 10deg
    [0.3827, 0.0, 0.0, 0.9239],        // Index1: 45deg
    [0.4226, 0.0, 0.0, 0.9063],        // Index2: 50deg
    [0.2588, 0.0, 0.0, 0.9659],        // Index3: 30deg
    [0.4067, 0.0, 0.0, 0.9135],        // Middle1: 48deg
    [0.4462, 0.0, 0.0, 0.8949],        // Middle2: 53deg
    [0.2756, 0.0, 0.0, 0.9613],        // Middle3: 32deg
    [0.4226, 0.0, 0.0, 0.9063],        // Ring1: 50deg
    [0.4617, 0.0, 0.0, 0.887],         // Ring2: 55deg
    [0.3007, 0.0, 0.0, 0.9537],        // Ring3: 35deg
    [0.4384, 0.0, 0.0, 0.8988],        // Pinky1: 52deg
    [0.4772, 0.0, 0.0, 0.8788],        // Pinky2: 57deg
    [0.3256, 0.0, 0.0, 0.9455],        // Pinky3: 38deg
  ],
};
...
const RELEASE_POSE: GripPose = {
  ...
  rotations: [
    ...
    [-0.0436, 0.0, 0.0, 0.999],        // Index1: -5deg (extended past neutral)
