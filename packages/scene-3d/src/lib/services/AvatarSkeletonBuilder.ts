 ...
 * Built at module load time - one entry per hand x 15 bones.
 *
...
export class AvatarSkeletonBuilder implements IAvatarSkeletonBuilder {
  ...
  private processGLTF(gltf: GLTF): void {
    ...
    this.buildArmChains();
    this.buildLegChains();
    this.state.fingerChains = this.buildFingerChains();
   ...
   */
  private buildFingerChains(): FingerChains | null {
