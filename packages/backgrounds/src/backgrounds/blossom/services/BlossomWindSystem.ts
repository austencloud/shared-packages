/**
 * BlossomWindSystem - Gentle wind gust management for cherry blossoms
 *
 * Unlike Autumn's more dramatic gusts, Blossom wind is:
...
import {
  CHERRY_WIND,
  CHERRY_WIND_MOBILE,
} from "../domain/constants/blossom-constants.js";
...
export interface BlossomWindSystem {
...
export function createBlossomWindSystem(): BlossomWindSystem {
