...
import type { CherryPetal, PetalDepth } from "../domain/models/blossom-models.js";
import {
  CHERRY_COUNTS,
...
/**
 * Creates and manages the blossom petal particle system
 */
export function createBlossomPetalSystem() {
  /**
