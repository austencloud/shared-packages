...
import type { CherryPetal } from "../domain/models/blossom-models.js";
import { createBlossomPetalSystem } from "./BlossomPetalSystem.js";
import { createBlossomWindSystem, type BlossomWindSystem } from "./BlossomWindSystem.js";
import {
  type TimeOfDay,
...
import { BlossomStarSystem } from "./environment/BlossomStarSystem.js";
 ...
 */
export interface BlossomLayers {
  // Core
  gradient: boolean;
  petals: boolean;
...
export class BlossomBackgroundSystem implements IBackgroundSystem {
  private petalSystem: ReturnType<typeof createBlossomPetalSystem>;
  private windSystem: BlossomWindSystem;
  ...
  constructor() {
    this.petalSystem = createBlossomPetalSystem();
    this.windSystem = createBlossomWindSystem();
    ...
    this.starSystem = new BlossomStarSystem(this.quality);
   ...
   */
  public setLayerVisibility(layers: Partial<BlossomLayers>): void {
   ...
   */
  public getLayerVisibility(): BlossomLayers {
    return { ...this.layers };
  }
