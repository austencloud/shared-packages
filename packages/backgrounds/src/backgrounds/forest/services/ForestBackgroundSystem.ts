...
export class ForestBackgroundSystem implements IBackgroundSystem {
  ...
  private layerVisibility: ForestLayers = {
    gradient: true,
    stars: true,
    moon: true,
    shootingStars: true,
  ...
  public setLayerVisibility(layers: Partial<ForestLayers>): void {
    this.layerVisibility = { ...this.layerVisibility, ...layers };
  }

  public getLayerVisibility(): ForestLayers {
