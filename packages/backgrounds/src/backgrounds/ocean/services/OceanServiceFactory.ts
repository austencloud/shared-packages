/**
 * Ocean Service Factory
 *
 * Creates and caches all Ocean-specific services including
...
/**
 * Container for all Ocean services
 */
...
// Cached services
let cachedServices: OceanServices | null = null;

/**
 * Get or create all Ocean services
 */
export function getOceanServices(): OceanServices {
  if (!cachedServices) {
 ...
 */
export function resetOceanServices(): void {
  cachedServices = null;
}
