...
import type { CosmicConfig } from "../domain/constants/cosmic-constants.js";
import { CometSystem } from "./CometSystem.js";
import { ConstellationSystem } from "./ConstellationSystem.js";
import type { ICosmicCalculationService } from "./contracts/ICosmicCalculationService.js";
...
import { getCosmicServices } from "./CosmicServiceFactory.js";
...
export class CosmicBackgroundSystem implements IBackgroundSystem {
  // core state -------------------------------------------------------------
  ...
  private calculationService!: ICosmicCalculationService;
  ...
  private cfg!: typeof CosmicConfig;
  ...
  static create(): CosmicBackgroundSystem {
    const instance = new CosmicBackgroundSystem();
    ...
    // Get Cosmic specific services
    const cosmicServices = getCosmicServices();
    instance.calculationService = cosmicServices.calculationService;
    ...
    instance.cfg = optimized.config.cosmic as typeof CosmicConfig;
    ...
    instance.ufoSystem = new UFOSystem(
      instance.cfg.ufo,
      instance.calculationService,
      cosmicServices.ufoRenderer,
      cosmicServices.ufoParticleRenderer,
      cosmicServices.ufoMoodManager,
      cosmicServices.ufoStarScanner,
      cosmicServices.ufoInteractionHandler,
      cosmicServices.ufoBehaviorRunner,
      cosmicServices.ufoEntranceAnimator,
      cosmicServices.ufoExitAnimator,
      cosmicServices.ufoMovementController,
      cosmicServices.ufoDecisionMaker
    );
  ...
  public setQuality(q: QualityLevel) {
    ...
    this.cfg = optimized.config.cosmic as typeof CosmicConfig;
  ...
  /**
   * Control visibility of individual layers (for Cosmic Lab)
   */
